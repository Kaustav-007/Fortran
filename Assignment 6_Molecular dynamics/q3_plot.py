...
data1 = np.loadtxt('energy_q3.dat')
...
plt.title(r'Energy vs Iteration with thermostat', fontsize = 24)
plt.legend(loc='upper right',prop={'size': 12},fontsize = 18, frameon = True)
plt.grid()
plt.show()
