...
data1 = np.loadtxt('dist_rand_walk_1k_bin_2.dat')
data2 = np.loadtxt('dist_rand_walk_1k_bin_5.dat')
data3 = np.loadtxt('dist_rand_walk_1k_bin_10.dat')
...
plt.title('Distribution of sum of 100k random walk steps for diiferent bin sizes')
plt.grid()
